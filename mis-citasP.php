                ...
                <div class="table-citas" style="max-width: 900px; width: 100%;" >
                    <div>
                        <div class="d-flex border-bottom">
                            <p class="border-right" >Fecha</p>
                            <p class="border-right">Hora</p>
                            <p class="border-right">Doctor(a)</p>
                            <p class="border-right">Estado de Pago</p>
                            <p class="">Asistió</p>
                        </div>
                        <div class="d-flex">
                            <p class="border-right pt-3">12/10/2020</p>
                            <p class="border-right pt-3">10:00 am</p>
                            <p class="border-right pt-3">Nelly Zevallos</p>
                            <p class="border-right pt-3"> Pagado </p>
                            <p class="pt-3">-</p>
                        </div>
                    </div>
                    <br>
                    <div>
                        ...
                        <div class="d-flex">
                            <p class="border-right pt-3" >19/10/2020</p>
                            <p class="border-right pt-3" >1:00 pm</p>
                            <p class="border-right pt-3" >Nelly Zevallos</p>
                            <p class="border-right pt-3"> Pendiente </p>
                            <p class="pt-3"> - </p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="d-flex">
                            <p class="border-right pt-3">26/10/2020</p>
                            <p class="border-right pt-3">11:00 am</p>
                            <p class="border-right pt-3">Nelly Zevallos</p>
                            <p class="border-right pt-3"> Pendiente </p>
                            <p class="pt-3"> - </p>
                        </div>
