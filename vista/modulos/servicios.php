<main>
    <section min-width="360">
        ...
        <table width="80%">
            <tr>
                ...
                <td align="end" width="50%">
                    <img width="90%" src="vista/image/ortopantomografia.jpg" alt="Ortopantomografía">
                </td>
            </tr>
        </table>
        <br>
        ...
        <table width="80%">
            ...
            <tr>
                <td align="center" width="100%">
                    <img width="70%" src="vista/image/diseñoSonrisa.jpg" alt="Ortopantomografía">
                </td>
            </tr>
            <tr>
                <td><br></td>
        ...
        <table width="80%">
            <tr>
                <td align="start" width="50%">
                    <img width="90%" src="vista/image/sonrisa.jpg" alt="sonrisa">
                </td>
